...
static const char _datTextIDs[]=""
//Count of IDs in class:                   -0000-                          -2000-                          -4000-                          -6000-                          -8000-                          -A000-                          -C000-                          -E000-
	"\x05\xC4\xC5\xC9\xCD\xCE";
...
static const char _datcallbacks[]="\x05\x0A\x4A\x01"
"\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
"\x00\x83\x8F\x7F\x10\x20"
				"\x04\x8F\x83\x07\x9F\x8F\x07\x07\x07\x00\x07\x07"
//v 20             x4              x8              xC
...
"\x80\x80\x80\x80\x80\x80\x80\x80\x80\x80\x80\x80\x80\x80\x80\x80"
"\x80\x80\x80\x80\x80\x80\x80\x80\x80\x80\x80\x80\x80\x80\x80\x80"
"\x04\x04\x04\x07\x0C\x0B\x0E\x07\x04\x0A";
...
// 00              04              08              0C
"\xFF\xDF\xDF\xFF\x5F\x8F\xD9\x0F\x01\x0F\x0D\x8F\x01\x5F\x50\x09"
"\x00\x00\x00\x00\x00\x00\x00\x01\xFF\x01\x02\x00\xFF\x00\x00\xFF";
...
static const char _dat0[]="\x0C\x04\x0F"
...
"\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\x14\xFE\x01\x01\xFF\xFF\xFE\x01\x22\xFF\x34\x01\xFF\xFF\x32\x21\x02\x19\xFE\x01\x04\xFE\xFE\xFE\x01\x01\x01\xFE\x00"
  "\x03r\xFE\x80\x00"//                ^^
	"l\\\x00l\\\x00l\\\x00l\\\x00|\x34*\xFE\x01\x80\x00"
	  "\x01\x01\x01\x01\x01\x01\x34\x00"
  "\x01r\xFE\x80\x00"//                                    ^^
	"\x01\x01\x01\x03r\03x\x81\x82\x00"
  "\x01r\xFE\x80\x00"//                                                                                    ^^
	"\x02\x02\x02\x01\x02\x01\x01r\xFE\x86\x00"
	  "\xFEr\xFE\x02\x01\x00"//     ^^
		"l\x7B\x01|l\x7C\x01|l\x7D\x01|l\x7E\x01|\x01\x00"
		"l\x7E*\x01\x01\x7F|\x01\x00"
  "\x01r\xFE\x80\x00"//                                                                                                ^^
	"\x01\x01\x01\x00"
  "\x01r\x01\x80\x00"//                                                                                                    ^^
  "\x01r\x01\x80\x00"//                                                                                                        ^^
  "\x01r\xFE\x80\x00"//                                                                                                                        ^^
	"\x01\x01\x01r\01x\x81\x82\x00"
"\x00"
"\xFF\xFF\xFF\xFF\xFF\xFF\xFF\xFF\x14\x02\x02\x00"
;

static const char _dat2v[]="\x0D\x07\x0F\x13"
...
static const char _datIDs[]="\x77\x01\x0F\x73\x00\x57\x00\x0A\x00\x28\x00\xFF\x00\x07\x00\x0A\x00\xFF\x00\x00\x00\xFF\x00\x24\x00\x1F\x00\xFF\xFF\xFF\x00\x00\x00\xFF\x00";
