...
/*158*/ OBJECT, OBJECT, OBJECT, OBJECT, OBJECT, OBJECT, VEHICLE,
NDF_END
};
#undef W
#undef TRAIN
...
/*28*/ WORD | HEX, WORD | HEX, DWORD | DATE, WORD,
END,
...
/*18*/ WORD | HEX, WORD | HEX, DWORD | DATE, EXTBYTE, BYTE, WORD,
END,
...
/*18*/ WORD | HEX, WORD | HEX, DWORD | DATE, EXTBYTE, WORD,
END,
...
/*18*/ BYTE, WORD | HEX, BYTE, TEXTID, TEXTID,
END,
...
BYTE(0x48), DWORD(0x49), DWORD(0x4A), DWORD(0x4B),
WORD(0x5F),
BYTE6x(0x60, 0x73),
LASTVAR80(0xFF),
// Feature 01:
