...
/*12*/ ACT0 | ACT1 | ACT3 | ACT4,
/*13*/ ACT0 | ACT1 | ACT3 | ACT4,
/*14*/ ACT0 | ACT1 | ACT3 | ACT4,
...
/*28*/ WORD | HEX, WORD | HEX, DWORD | DATE, WORD, SUBDATA, SUBDATA, WORD, WORD,
/*30*/ DWORD, BYTE,
END,
// Subdata - prop 2C:
...
/*20*/ EXTBYTE, BYTE, WORD, BYTE, SUBDATA, SUBDATA, WORD, DWORD, BYTE,
END,
// Subdata - prop 24:
BYTE, REPEAT_N(BYTE, DATAFROM(0)), END,
// Subdata - prop 25:
...
/*20*/ SUBDATA, WORD | DECIMAL, WORD | DECIMAL, SUBDATA,
END,
// Subdata - prop 0A:
...
BYTE, REPEAT_N(BYTE, DATAFROM(0)), END,
// Subdata - prop 23:
BYTE, REPEAT_N(SUBDATA, DATAFROM(0)), END,
	BYTE, BYTE, END,
...
/*14*/ SUBDATA,       0x7E, 0x7E, BYTE,           0x7E, 0x7E, DWORD | QUOTED, 0x00, 0xFC, DWORD | QUOTED, 0x00, 0xFC,
END,
// Subdata - prop 10:
...
/*20*/ DWORD, BYTE, BYTE, DWORD | DECIMAL, TEXTID, SUBDATA, SUBDATA, SUBDATA, SUBDATA,
END,
// Subdata - prop 0A:
...
BYTE, REPEAT_N(BYTE, DATAFROM(0)), END,
// Subdata - prop 28:
BYTE, BYTE, REPEAT_N(WORD, MUL(DATAFROM(0), DATAFROM(1))), END,
...
// Feature 12:
/*00*/ INVALID, INVALID, INVALID, INVALID, INVALID, INVALID, INVALID, INVALID,
/*08*/ DWORD | QUOTED, WORD, WORD, WORD, WORD, WORD, INVALID, SUBDATA,
/*10*/ BYTE, INVALID, INVALID, WORD, WORD, INVALID, BYTE, DWORD | DATE,
/*18*/ SUBDATA, SUBDATA, BYTE, WORD, WORD, SUBDATA,
END,
// Subdata - prop 0F:
BYTE, REPEAT_N(DWORD | QUOTED, DATAFROM(0)), END,
...
// Feature 14:
/*00*/ INVALID, INVALID, INVALID, INVALID, INVALID, INVALID, INVALID, INVALID,
/*08*/ DWORD | QUOTED, BYTE, WORD, WORD, BYTE, WORD | HEX, WORD | HEX, BYTE | DECIMAL,
/*10*/ WORD, WORD | HEX, BYTE | HEX, INVALID, INVALID, SUBDATA,
END,
// Subdata - prop 15:
BYTE, BYTE, END,
...
WORD(0x5F),
BYTE6x(0x60, 0x73), DWORD6x(0x61, 0xFF), DWORD6x(0x62, 0xFF), DWORD6x(0x63, 0xFF),
LASTVAR80(0xFF),
// Feature 01:
/*Related:*/ 0x01,
...
BYTE(0x48), DWORD(0x49), DWORD(0x4A), DWORD(0x4B), DWORD(0x4C), WORD(0x4D),
WORD(0x5F),
DWORD6x(0x61, 0xFF), DWORD6x(0x62, 0xFF), DWORD6x(0x63, 0xFF),
LASTVAR80(0xFF),
// Feature 02:
/*Related:*/ 0x02,
...
/*Related:*/ 0x08,
BYTE(0x11),
DWORD(0x40), DWORD(0x41), WORD(0x42), DWORD(0x43), BYTE(0x44), WORD(0x45), DWORD(0x46), DWORD(0x47),
...
// Feature 0A:
/*Related:*/ 0x08,
WORD(0x40), WORD(0x41), WORD(0x42), WORD(0x43), BYTE(0x44), DWORD(0x45), DWORD(0x46), DWORD(0x47),
VAR(0x5F, 3),
...
DWORD6x(0x68, 0xFF), DWORD6x(0x69, 0xFF), DWORD6x(0x6A, 0xFF), DWORD6x(0x6B, 0xFF),
DWORD6x(0x6C, 0xFF), DWORD6x(0x6D, 0xFF), DWORD6x(0x6E, 0xFF), DWORD6x(0x6F, 0xFF),
DWORD6x(0x70, 0xFF), DWORD6x(0x71, 0xFF),
DWORD6x(0x7C, 0x0F),
LASTVAR80(0xB5),
// Feature 0B:
/*Related:*/ 0x0B,
...
// Feature 0D:
/*Related:*/ 0x0D,
DWORD(0x40), DWORD(0x48),
DWORD(0x5F),
WORD6x(0x60, 0xFF), BYTE6x(0x61, 0xFF), DWORD6x(0x62, 0xFF), BYTE6x(0x63, 0xFF), WORD6x(0x64, 0xFF),
BYTE6x(0x65, 0xFF), BYTE6x(0x69, 0xFF),
LASTVAR80(0xFF),
// Feature 0E:
/*Related:*/ 0x0E,
DWORD6x(0x60, 0xFF),
...
// Feature 14:
/*Related*/ 0x08,
BYTE(0x40), BYTE(0x41), BYTE(0x42), DWORD(0x43), DWORD(0x44),
VAR(0x45, 3), DWORD(0x46), DWORD(0x47), DWORD(0x48), BYTE(0x49),
DWORD(0x45),
WORD6x(0x60, 0xFF), BYTE6x(0x61, 0xFF), DWORD6x(0x62, 0xFF), BYTE6x(0x63, 0xFF),
WORD6x(0x64, 0xFF), BYTE6x(0x65, 0xFF), DWORD6x(0x66, 0xFF), DWORD6x(0x67, 0xFF),
DWORD6x(0x68, 0xFF), BYTE6x(0x69, 0xFF), DWORD6x(0x6A, 0xFF),
LASTVAR80(0xFF),
NDF_END
};
#undef ALLOW0MASK
...
/*0B*/ACT2RANDOM( 0,  0, 0),
/*0C*/ACT2RANDOM( 0,  0, 0),
/*0D*/ACT2RANDOM(16,  0, 0),
/*0E*/ACT2RANDOM( 0,  0, 0),
/*0F*/ACT2RANDOM( 8,  0, 0),
/*10*/ACT2RANDOM( 2,  0, 0),
/*11*/ACT2RANDOM(20,  0, 0),
/*12*/ACT2RANDOM( 2,  0, 0),
/*13*/ACT2RANDOM( 2,  0, 0),
/*14*/ACT2RANDOM(24,  0, 5),
NDF_END
};
#undef ACT2RANDOM
