...
Nástroj nainstalujete překopírováním souboru nforenum.exe do jakéhokoliv adresáře
...
adresář se jménem .nforenum, kam bude ukládat veškeré datové soubory.
Při upgradu programu není třeba tento adresář odstraňovat - program
automaticky obnoví zastaralé soubory.
K odinstalování stačí smazat nforenum.exe a všechny datové .nforenum adresáře.
...
> nforenum [možnosti] MujGRF1 MujGRF2
...
Standardní cesty použité při hledání/vytváření datového adresáře .nforenum jsou
uvedeny v následujícím seznamu:
  . (stávající adresář)
  $HOME
  $HOMEDRIVE$HOMEPATH
V případě, že adresář .nforenum není nalezen ani v jednom z těchto míst, NFORenum
